            ...
            <center>
                ...
                <div class="pg_body horizontal-wrapper animated lightSpeedIn fast" id="plans">
                    ...
                    <div class="box1 pl" id="plan_s">
                        ...
                        <h2 id="vl2"> <img src="img/rupee.png" alt="" width="40px" height="40px"> 400 </h2>
                        
                    </div>
                    <h6 style="margin-left:0;position:absolute;bottom:-70%;left:5%;font-weight:100">In this plan, you need to upload your own sketch <br>in order to avail the discount. </h6>
                    
                    <div class="box1 pl" id="plan_b">
                        <img src="img/basic.png" alt="gallary_img">  
                        <h2 id="vl1"> <img src="img/rupee.png" alt="" width="40px" height="40px"> 600 </h2>
                    </div>
                    
                    <div class="box1 pl" id="plan_p">
                        <img src="img/sketch.png" alt="gallary_img">
                        <h2 id="vl"> <img src="img/rupee.png" alt="" width="40px" height="40px"> 1000 </h2>
                    </div>
    ...
    <script>
        ...
        if (!isPlanned) {
            ...
            sketchP.addEventListener("click", function() {
                ...
                location.href = "payment.php?id=sfs363";
        ...
        if (!isPlanned) {
            ...
            basicP.addEventListener("click", function() {
                ...
                location.href = "payment.php?id=klr572";
        ...
        if (!isPlanned) {
            ...
            proP.addEventListener("click", function(e) {
                ...
                location.href = "payment.php?id=gkd981";
